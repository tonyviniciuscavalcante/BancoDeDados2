...
UPDATE atleta SET salario = 8000 WHERE nome = 'Miquela Malloy';

INSERT INTO atleta (id, nome, cpf, salario) VALUES (199, 'Rebeca Andrade', '888-77-5555', 2500);
...
UPDATE atleta SET salario = 100000 WHERE nome = 'Rebeca Andrade'; -- Errou o salário

SELECT * FROM hr.atleta WHERE nome = 'Rebeca Andrade';

ROLLBACK TO ATUALIZA;

SELECT * FROM hr.atleta WHERE nome in ('Oren Peers', 'Johna Belf', 'Rebeca Andrade');

UPDATE atleta SET salario = 7300 WHERE nome = 'Lambert Taffs';

COMMIT;

SELECT * FROM hr.atleta WHERE nome in ('Lambert Taffs');
...
INSERT INTO EMP_TEMP (cod, nome, sal) VALUES (1, 'Tony', 3500);
INSERT INTO EMP_TEMP (cod, nome, sal) VALUES (12, 'Edric', 8000);


-- 6. Como HR, efetive permanentemente as inserções realizadas e depois, como
-- JOSE, consulte novamente os registros de EMP_TEMP.
COMMIT;
-- Agora aparece na sessão do Jose

-- 7. Como HR, insira outros 2 registros na tabela EMP_TEMP.
INSERT INTO EMP_TEMP (cod, nome, sal) VALUES (3, 'Joao', 5500);
INSERT INTO EMP_TEMP (cod, nome, sal) VALUES (4, 'Vinicius', 4600);
...
UPDATE EMP_TEMP SET sal = 150 WHERE nome = 'Vinicius';
-- Como não foi comitado o salario nao se altera para o Jose

-- 12. Como HR, desfaça a alteração que dobrava o salário do empregado e consulte os
-- dados do empregado. Então, como JOSE, consulte também os dados desse
-- empregado.
ROLLBACK;
...
UPDATE EMP_TEMP SET sal = 8400 WHERE nome = 'Tony';
-- Jose fica travado até o HR dar um commit de alguma forma

-- 19. Como HR, desfaça a última alteração de salário feita. O que aconteceu em cada
-- uma das sessões agora? Faça um SELECT no registro alterado nas duas sessões e compare.
ROLLBACK;
-- Sessao do Jose destravou e rodou o update na sessão dele, e a do HR retornou para a original.
